...
class singleAssetFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var supportFragmentManager : FragmentManager? = activity?.supportFragmentManager
        activity?.onBackPressedDispatcher?.addCallback(this,object : OnBackPressedCallback(true){
            override fun handleOnBackPressed() {
                Timber.e("Pressing back button => BackStack: ${activity.toString()} \n $supportFragmentManager")
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_single_asset, container, false)
    }
